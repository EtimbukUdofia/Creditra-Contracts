...
impl Credit {
    ...
    pub fn repay_credit(env: Env, borrower: Address, amount: i128) {
        ...
        let principal_to_pay = effective_repay - interest_to_pay;

        credit_line.accrued_interest = credit_line.accrued_interest.saturating_sub(interest_to_pay);
        ...
        publish_repayment_event(
            ...
            RepaymentEvent {
                ...
                principal_repaid: principal_to_pay,
